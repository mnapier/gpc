...
- Current version: v0.9.88 — pre-release series (`0.9.x` → `1.0.0` public launch)
...
- 2,418 total tests, 7 packages building, 90%+ line coverage on all core packages
...
- Vitest for all tests (2,418 total across 7 packages + e2e)
...
| `gpc-enterprise`          | Managed Google Play private app publishing (Play Custom App Publishing API)                   |
| `gpc-android-cli-interop` | Handoff router between Google's Android CLI (build/dev) and GPC (publishing)                  |
| `gpc-games`               | Play Games Services achievement + leaderboard configuration CRUD (`gpc games`)                |
