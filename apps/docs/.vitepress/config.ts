...
export default defineConfig({
      ...
      const faqSchema = {
        ...
        mainEntity: [
          ...
          },
          {
            ...
            acceptedAnswer: {
              "@type": "Answer",
              text: "2,319 tests across 7 packages at 90%+ line coverage. Every write operation supports --dry-run. Semantic exit codes for CI branching.",
            },
          },
          {
            "@type": "Question",
  ...
  themeConfig: {
    ...
    socialLinks: [
      ...
      {
        icon: {
          svg: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path fill="currentColor" d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2m0 4-8 5-8-5V6l8 5 8-5z"/></svg>',
        },
